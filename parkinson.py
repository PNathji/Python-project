...
# standardize the data
        ...
        if prediction[0] == 0:
            result_message = "The person does not have Parkinson's Disease"
        else:
            result_message = "The person has Parkinson's Disease"

    # Render the result template with the result message
    return render_template('result.html', result_message=result_message, c1=c1, c2=c2, c3=c3, c4=c4, c5=c5, c6=c6, c7=c7, c8=c8, c9=c9, c10=c10, c11=c11, c12=c12, c13=c13, c14=c14, c15=c15, c16=c16, c17=c17, c18=c18, c19=c19, c20=c20, c21=c21, c22=c22)
